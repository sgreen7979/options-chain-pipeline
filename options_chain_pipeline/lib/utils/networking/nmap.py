...
__version__ = "0.7.0.2"
__last_modification__ = "2021.06.29"
...
ScanType = Dict[str, ScanEntryType]
############################################################################
...
class PortScanner(object):
    ...
    def analyse_nmap_xml_scan(  # NOQA: CFQ001, C901
        ...
        runstats_finished = dom.find("runstats/finished")
        timestr = None
        elapsed = None
        uphosts = None
        downhosts = None
        totalhosts = None
        if runstats_finished is not None:
            timestr = runstats_finished.get("timestr")
            elapsed = runstats_finished.get("elapsed")
            uphosts = runstats_finished.get("up")
            downhosts = runstats_finished.get("down")
            totalhosts = runstats_finished.get("total")
...
class PortScannerHostDict(dict):
    """
    Special dictionary class for storing and accessing host scan result
