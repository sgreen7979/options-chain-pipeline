...
class Portfolio:
    def __init__(self, account_number: Optional[str] = None) -> None:
        ...
        self._schwab_client: SchwabClient = None
    ...
    def portfolio_weights(self) -> dict:
        ...
        # Grab the quotes.
        quotes = self.schwab_client.get_quotes(instruments=list(symbols))
    ...
    @property
    def schwab_client(self) -> SchwabClient:
        """Gets the SchwabClient object for the Portfolio

        Returns:
        ----
        {SchwabClient} -- An authenticated session with the Schwab API.
        """

        return self._schwab_client

    @schwab_client.setter
    def schwab_client(self, schwab_client: SchwabClient) -> None:
        """Sets the SchwabClient object for the Portfolio

        Arguments:
        ----
        schwab_client {SchwabClient} -- An authenticated session with the Schwab API.
        """

        self._schwab_client: SchwabClient = schwab_client
