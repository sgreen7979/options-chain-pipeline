...
class BaseClient(EnumEnforcer):
    ...
    def _log_response(self, resp, req_num):
        self.logger.debug(
            'Req %s: GET response: %s, content=%s', req_num, resp.status_code, resp.text
        )
    ...
    def _assert_type(self, name, value, exp_types):
        ...
        value_type_name = '{}.{}'.format(value_type.__module__, value_type.__name__)
        exp_type_names = ['{}.{}'.format(t.__module__, t.__name__) for t in exp_types]
    ...
    def token_age(self):
        ...
        return self.token_metadata.token_age()  # type: ignore
    ...
    def get_account(self, account_hash, *, fields=None):
        ...
        return self._get_request(path, params)  # type: ignore
    ...
    def get_account_numbers(self):
        ...
        return self._get_request(path, {})  # type: ignore
    ...
    def cancel_order(self, order_id, account_hash):
        ...
        path = '/trader/v1/accounts/{}/orders/{}'.format(account_hash, order_id)
        return self._delete_request(path)  # type: ignore
    ...
    def _make_order_query(
        ...
        *,
        ...
        if from_entered_datetime is None:
            from_entered_datetime = datetime.datetime.now(
    ...
    def get_orders_for_account(
        ...
        *,
        ...
        return self._get_request(  # type: ignore
            path,
            self._make_order_query(
    ...
    def place_order(self, account_hash, order_spec):
        ...
        path = '/trader/v1/accounts/{}/orders'.format(account_hash)
        return self._post_request(path, order_spec)  # type: ignore
    ...
    def replace_order(self, account_hash, order_id, order_spec):
        ...
        path = '/trader/v1/accounts/{}/orders/{}'.format(account_hash, order_id)
        return self._put_request(path, order_spec)  # type: ignore
    ...
    def get_transactions(
        ...
        *,
        ...
        if transaction_types is None:
            transaction_types = [t.value for t in self.Transactions.TransactionType]
        else:
        ...
        params = {
            'types': ','.join(transaction_types),  # type: ignore
    ...
    def get_quotes(self, symbols, *, fields=None, indicative=None):
        ...
        if indicative is not None:
            if type(indicative) is not bool:
                raise ValueError('value of \'indicative\' must be either True or False')
    ...
    def get_option_chain(
        ...
        *,
        ...
        '''
        contract_type = self.convert_enum(contract_type, self.Options.ContractType)
        strategy = self.convert_enum(strategy, self.Options.Strategy)
        strike_range = self.convert_enum(strike_range, self.Options.StrikeRange)
    ...
    def get_option_expiration_chain(self, symbol):
        ...
        return self._get_request(path, {'symbol': symbol})  # type: ignore
    ...
    def get_price_history(
        ...
        *,
        ...
        :param need_previous_close: If true, return the previous close price and
                                    date.
        '''
        period_type = self.convert_enum(period_type, self.PriceHistory.PeriodType)
        ...
        frequency = self.convert_enum(frequency, self.PriceHistory.Frequency)
    ...
    def __normalize_start_and_end_datetimes(self, start_datetime, end_datetime):
        ...
        if end_datetime is None:
            end_datetime = datetime.datetime.utcnow() + datetime.timedelta(days=7)
    ...
    def get_market_hours(self, markets, *, date=None):
        ...
        params = {'markets': ','.join(markets)}  # type: ignore
        if date is not None:
            params['date'] = self._format_date_as_day('date', date)

        return self._get_request('/marketdata/v1/markets', params)  # type: ignore
    ...
    def get_instruments(self, symbols, projection):
        ...
        return self._get_request('/marketdata/v1/instruments', params)  # type: ignore
    ...
    def get_instrument_by_cusip(self, cusip):
        ...
        return self._get_request('/marketdata/v1/instruments/{}'.format(cusip), {})  # type: ignore
