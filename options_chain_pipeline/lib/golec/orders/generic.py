...
def truncate_float(flt):
    warnings.warn(
        'passing floats to set_price and set_stop_price is '
...
class OrderBuilder(EnumEnforcer):
    ...
    def set_price_link_basis(self, price_link_basis):
        ...
        '''
        price_link_basis = self.convert_enum(price_link_basis, common.PriceLinkBasis)
    ...
    def set_price_link_type(self, price_link_type):
        ...
        '''
        price_link_type = self.convert_enum(price_link_type, common.PriceLinkType)
